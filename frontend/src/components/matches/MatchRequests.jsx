...
const ReceivedRequests = (props) => {
    ...
    const handleReject = async () =>{
        // console.log('hello')
        const res = await fetch("https://backend-crickfix.onrender.com/teams/match_request_reject/"+props.id+"/"+props.player._id, {
            method: "POST",
            headers: {
...
const AcceptedRequests = (props) => {
    ...
    const handleBatting =async () => {
        const res = await fetch('https://backend-crickfix.onrender.com/matches/setbatting/'+props.matchId, {
            method: "GET",
            headers: {
    ...
    const handleBowling = async () => {
        console.log('hello')
        const res = await fetch('https://backend-crickfix.onrender.com/matches/setbowling/'+props.matchId, {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json"
...
const TeamRequests = () => {
    ...
    const fetchRequests = async () => {
        try {
            const res = await fetch('https://backend-crickfix.onrender.com/teams/matchRequests/'+id, {
                method: "GET",
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json"
